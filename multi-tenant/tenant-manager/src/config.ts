...
const envSchema = z.object({
  ...
  SIGNATURE_TOLERANCE: z
    .string()
    .default("300")
    .transform((v) => parseInt(v, 10)), // 5 minutes
  ...
  // Liuma Authentication Center
  LIUMA_URL: z.string().url().default("https://auth.liuma.app"),
});
